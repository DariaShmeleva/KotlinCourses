...
class Coupe(override val brand: String, override val speed: String, override val price: Int, var gasUpSound: String = "Wrom wrom") :
    Car {
    ...
    override fun printPetrolInfo():String = "ru.tinkoff.shmeleva.lesson1.car.Coupe petrol reserve: $brand has $petrol liters"
